...
judul = Label(frameJudul, bg='white', text='Data Pinjam Buku', font=styling)
...
matkulinfo = Label(frameMatkul, bg='white', text='Judul Buku', font=styling2)
